...
fn compile_curried_call(func_src: String, args_src: &[String]) -> String {
    ...
    args_src.iter().fold(func_src, |acc, arg| format!("({} {})", acc, arg))
}
            ...
            match &items[0] {
                Expression::Word(op) =>
                    match op.as_str() {
                        ...
                        "car" =>
                            format!("(q-get {} 0)", compile_expr_inner(&items[1], mut_vars, false)),
                        "cdr" =>
                            format!(
                                "(q-cdr {} {})",
                                compile_expr_inner(&items[1], mut_vars, false),
                        ...
                        "fst" =>
                            format!("(q-get {} 0)", compile_expr_inner(&items[1], mut_vars, false)),
                        "snd" =>
                            format!("(q-get {} 1)", compile_expr_inner(&items[1], mut_vars, false)),
                        "set!" =>
                            format!(
                                "(do (q-set! {} {} {}) 0)",
                                compile_expr_inner(&items[1], mut_vars, false),
                        ...
                        "not" =>
                            format!("(not {})", compile_expr_inner(&items[1], mut_vars, false)),
                        "^" =>
                            format!(
                                "(bit-xor {} {})",
                                compile_expr_inner(&items[1], mut_vars, false),
