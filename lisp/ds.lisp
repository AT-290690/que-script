...
(let SignedBigInt->String std/int/big/signed/to-string)
...
(let StructDec/scale std/struct-dec/scale)
(let StructDec/zero std/struct-dec/zero)
(let StructDec/one std/struct-dec/one)
(let StructDec/pi std/struct-dec/pi)
(let StructDec/e std/struct-dec/e)
(let StructDec/new std/struct-dec/new)
(let StructDec/from-int std/struct-dec/from-int)
(let StructDec/from-scaled std/struct-dec/from-scaled)
(let StructDec/scaled std/struct-dec/scaled)
(let StructDec/negative? std/struct-dec/negative?)
(let StructDec/whole std/struct-dec/whole)
(let StructDec/fraction std/struct-dec/fraction)
(let StructDec/normalize std/struct-dec/normalize)
(let StructDec/negate std/struct-dec/negate)
(let StructDec/abs std/struct-dec/abs)
(let StructDec/add std/struct-dec/add)
(let StructDec/sub std/struct-dec/sub)
(let StructDec/mul std/struct-dec/mul)
(let StructDec/div std/struct-dec/div)
(let StructDec/equal? std/struct-dec/equal?)
(let StructDec/lt? std/struct-dec/lt?)
(let StructDec/lte? std/struct-dec/lte?)
(let StructDec/gt? std/struct-dec/gt?)
(let StructDec/gte? std/struct-dec/gte?)
(let StructDec/to-dec std/struct-dec/to-dec)

(let StructBigDec/zero std/struct-big-dec/zero)
(let StructBigDec/one std/struct-big-dec/one)
(let StructBigDec/pi std/struct-big-dec/pi)
(let StructBigDec/e std/struct-big-dec/e)
(let StructBigDec/precision std/struct-big-dec/precision)
(let StructBigDec/signed std/struct-big-dec/signed)
(let StructBigDec/negative? std/struct-big-dec/negative?)
(let StructBigDec/scale std/struct-big-dec/scale)
(let StructBigDec/new std/struct-big-dec/new)
(let StructBigDec/new-digits std/struct-big-dec/new-digits)
(let StructBigDec/from-int std/struct-big-dec/from-int)
(let StructBigDec/from-digits std/struct-big-dec/from-digits)
(let StructBigDec/from-scaled std/struct-big-dec/from-scaled)
(let StructBigDec/scaled std/struct-big-dec/scaled)
(let StructBigDec/whole std/struct-big-dec/whole)
(let StructBigDec/fraction std/struct-big-dec/fraction)
(let StructBigDec/add std/struct-big-dec/add)
(let StructBigDec/sub std/struct-big-dec/sub)
(let StructBigDec/mul std/struct-big-dec/mul)
(let StructBigDec/div std/struct-big-dec/div)
(let StructBigDec/div/precision std/struct-big-dec/div/precision)
(let StructBigDec/equal? std/struct-big-dec/equal?)
(let StructBigDec/lt? std/struct-big-dec/lt?)
(let StructBigDec/lte? std/struct-big-dec/lte?)
(let StructBigDec/gt? std/struct-big-dec/gt?)
(let StructBigDec/gte? std/struct-big-dec/gte?)
(let StructBigDec/negate std/struct-big-dec/negate)
(let StructBigDec/abs std/struct-big-dec/abs)
(let StructBigDec->String std/struct-big-dec/to-string)
...
(let String->Bool std/parse/bool?)
(let Char/eq? (lambda a b (=# a b)))
(let Int/eq? (lambda a b (= a b)))
(let Bool/eq? (lambda a b (=? a b)))

(let parse/bool? std/parse/bool?)
(let parse/words/as std/parse/words/as)
(let parse/lines/as std/parse/lines/as)
(let parse/int/words std/parse/int/words)
(let parse/dec/words std/parse/dec/words)
(let parse/bool/words std/parse/bool/words)
(let parse/string/words std/parse/string/words)
(let parse/int/lines std/parse/int/lines)
(let parse/dec/lines std/parse/dec/lines)
(let parse/bool/lines std/parse/bool/lines)

(let json/field std/json/field)
(let json/int std/json/int)
(let json/dec std/json/dec)
(let json/bool? std/json/bool?)
(let json/chars std/json/chars)
(let json/array std/json/array)
(let json/array/values std/json/array/values)
(let parse/string/lines std/parse/string/lines)
(let parse/int/matrix std/parse/int/matrix)
(let parse/dec/matrix std/parse/dec/matrix)
(let parse/row2 std/parse/row2)
(let parse/row3 std/parse/row3)
(let parse/row4 std/parse/row4)
(let parse/row5 std/parse/row5)
(let parse/row6 std/parse/row6)
