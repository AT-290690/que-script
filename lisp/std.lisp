...
(let std/char/A (get "A" 0))
(let std/char/B (get "B" 0))
(let std/char/C (get "C" 0))
(let std/char/D (get "D" 0))
(let std/char/E (get "E" 0))
(let std/char/F (get "F" 0))
(let std/char/G (get "G" 0))
(let std/char/H (get "H" 0))
(let std/char/I (get "I" 0))
(let std/char/J (get "J" 0))
(let std/char/K (get "K" 0))
(let std/char/L (get "L" 0))
(let std/char/M (get "M" 0))
(let std/char/N (get "N" 0))
(let std/char/O (get "O" 0))
(let std/char/P (get "P" 0))
(let std/char/Q (get "Q" 0))
(let std/char/R (get "R" 0))
(let std/char/S (get "S" 0))
(let std/char/T (get "T" 0))
(let std/char/U (get "U" 0))
(let std/char/V (get "V" 0))
(let std/char/W (get "W" 0))
(let std/char/X (get "X" 0))
(let std/char/Y (get "Y" 0))
(let std/char/Z (get "Z" 0))
(let std/char/a (get "a" 0))
(let std/char/b (get "b" 0))
(let std/char/c (get "c" 0))
(let std/char/d (get "d" 0))
...
(let std/char/y (get "y" 0))
(let std/char/z (get "z" 0))
(let std/char/0 (get "0" 0))
(let std/char/1 (get "1" 0))
(let std/char/2 (get "2" 0))
(let std/char/3 (get "3" 0))
(let std/char/4 (get "4" 0))
(let std/char/5 (get "5" 0))
(let std/char/6 (get "6" 0))
(let std/char/7 (get "7" 0))
(let std/char/8 (get "8" 0))
(let std/char/9 (get "9" 0))
...
(let std/int/hash
 (lambda table key (do
     ...
     (while (< i bounds) (do
           ...
           (alter! total (std/int/euclidean-mod (+ (* total prime-num) (as letter Int)) (length table)))
           (alter! i (+ i 1))))
     total)))
